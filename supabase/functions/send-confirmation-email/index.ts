...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // 患者様への確定メール送信
    console.log("患者様メール送信開始:", { to: patientEmail, from: "六本松矯正歯科クリニックとよしま <t@489.toyoshima-do.com>" });
    ...
    // 管理者への確定メール送信
    console.log("管理者メール送信開始:", { to: "t@489.toyoshima-do.com", from: "六本松矯正歯科クリニックとよしま予約システム <t@489.toyoshima-do.com>" });
